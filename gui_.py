...
current_player_profile = "Player: John Doe\nBalance: $1000"
...
def draw_bonus_window():
    ...
    for i in range(4):
        ...
        entry_text = font.render(f"Bonus {i+1}:", True, TEXT_COLOR)
        screen.blit(entry_text, (entry_rect.x - entry_text.get_width() - 10, entry_rect.centery - entry_text.get_height() // 2))

        entry_input_text = font.render(str(bonus_entries[i]), True, TEXT_COLOR)
